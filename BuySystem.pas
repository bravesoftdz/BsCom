...
var
  fmBuySystem: TfmBuySystem;

implementation

uses DMMain, Math, DB, ADODB, Contnrs, DefSeller;

{$R *.dfm}

procedure TfmBuySystem.FormShow(Sender: TObject);
begin
     ...
     begin
          ...
          tblOrder.Filter   := 'xSellFactorNo = Null and xIsSystemOrder = True';
...
procedure TfmBuySystem.BtnCloseClick(Sender: TObject);
begin
     close;
end;

procedure TfmBuySystem.FormCreate(Sender: TObject);
begin
     scrbMain.VertScrollBar.Position := 0;
end;

procedure TfmBuySystem.FormMouseWheel(Sender: TObject; Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint; var Handled: Boolean);
begin
...
procedure TfmBuySystem.lbledSellerKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key=VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSellerChange(Sender: TObject);
begin
     if Trim(lbledSeller.Text) <> '' Then
        fmDMmain.tblPerson.Locate('xPersonCode_Pk_AN',StrToInt(lbledSeller.Text),[]);
end;

procedure TfmBuySystem.FormClose(Sender: TObject;
...
procedure TfmBuySystem.FormKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfmBuySystem.lbledSelCpuKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key=VK_DOWN Then
     begin
...
procedure TfmBuySystem.cmbPardakhtKindChange(Sender: TObject);
var
   totalPrice:String;
begin
...
procedure TfmBuySystem.LoadDevice(ForInsert:Boolean;DeviceCode, DeviceNo: Integer);
begin
...
procedure TfmBuySystem.SelectedFieldExe(ForInsert:Boolean;DeviceNo:Integer);
begin
...
procedure TfmBuySystem.lbledSelCpuChange(Sender: TObject);
begin
     if Trim(lbledSelCpu.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelCpu.Text),1);
end;

procedure TfmBuySystem.btnSelCpuClick(Sender: TObject);
begin
     SelectedFieldExe(True,1);
end;

procedure TfmBuySystem.lbledSelRamChange(Sender: TObject);
begin
     if Trim(lbledSelRam.Text)= '' then Exit;
     LoadDevice(True,StrToint(lbledSelRam.Text),2);
end;

procedure TfmBuySystem.lbledSelRamKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelHardKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelMbKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelMonitorKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelCaseKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelCdRomKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelCdWriterKeyUp(Sender: TObject;
...
procedure TfmBuySystem.lbledSelDvdRomKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelDvdWriterKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelSpeakerKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelKeyBoardKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelMouseKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelSoundKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelVGAKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelScannerKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelPrinterKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelTvCardKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelLanCardKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelModemKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelWebCamKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelHeadSetKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelMicroPhoneKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelUPSKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelSwitchKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelFloppyKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelZipDriveKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelExtraKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelHardChange(Sender: TObject);
begin
     if Trim(lbledSelHard.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelHard.Text),3);
end;

procedure TfmBuySystem.lbledSelMbChange(Sender: TObject);
begin
     if Trim(lbledSelMb.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelMb.Text),4);
end;

procedure TfmBuySystem.lbledSelMonitorChange(Sender: TObject);
begin
     if Trim(lbledSelMonitor.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelMonitor.Text),5);
end;

procedure TfmBuySystem.lbledSelCaseChange(Sender: TObject);
begin
     if Trim(lbledSelCase.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelCase.Text),6);
end;

procedure TfmBuySystem.lbledSelCdRomChange(Sender: TObject);
begin
     if Trim(lbledSelCdRom.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelCdRom.Text),7);
end;

procedure TfmBuySystem.lbledSelCdWriterChange(Sender: TObject);
begin
     if Trim(lbledSelCdWriter.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelCdWriter.Text),8);
end;

procedure TfmBuySystem.lbledSelDvdRomChange(Sender: TObject);
begin
     if Trim(lbledSelDvdRom.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelDvdRom.Text),9);
end;

procedure TfmBuySystem.lbledSelDvdWriterChange(Sender: TObject);
begin
     if Trim(lbledSelDvdWriter.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelDvdWriter.Text),10);
end;

procedure TfmBuySystem.lbledSelSpeakerChange(Sender: TObject);
begin
     if Trim(lbledSelSpeaker.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelSpeaker.Text),11);
end;

procedure TfmBuySystem.lbledSelKeyBoardChange(Sender: TObject);
begin
     if Trim(lbledSelKeyBoard.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelKeyBoard.Text),12);
end;

procedure TfmBuySystem.lbledSelMouseChange(Sender: TObject);
begin
     if Trim(lbledSelMouse.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelMouse.Text),13);
end;

procedure TfmBuySystem.lbledSelSoundChange(Sender: TObject);
begin
     if Trim(lbledSelSound.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelSound.Text),14);
end;

procedure TfmBuySystem.lbledSelVGAChange(Sender: TObject);
begin
     if Trim(lbledSelVGA.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelVGA.Text),15);
end;

procedure TfmBuySystem.lbledSelScannerChange(Sender: TObject);
begin
     if Trim(lbledSelScanner.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelScanner.Text),16);
end;

procedure TfmBuySystem.lbledSelPrinterChange(Sender: TObject);
begin
     if Trim(lbledSelPrinter.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelPrinter.Text),17);
end;

procedure TfmBuySystem.lbledSelTvCardChange(Sender: TObject);
begin
     if Trim(lbledSelTvCard.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelTvCard.Text),18);
end;

procedure TfmBuySystem.lbledSelLanCardChange(Sender: TObject);
begin
     if Trim(lbledSelLanCard.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelLanCard.Text),19);
end;

procedure TfmBuySystem.lbledSelModemChange(Sender: TObject);
begin
     if Trim(lbledSelModem.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelModem.Text),20);
end;

procedure TfmBuySystem.lbledSelWebCamChange(Sender: TObject);
begin
     if Trim(lbledSelWebCam.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelWebCam.Text),21);
end;

procedure TfmBuySystem.lbledSelHeadSetChange(Sender: TObject);
begin
     if Trim(lbledSelHeadSet.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelHeadSet.Text),22);
end;

procedure TfmBuySystem.lbledSelMicroPhoneChange(Sender: TObject);
begin
     if Trim(lbledSelMicroPhone.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelMicroPhone.Text),23);
end;

procedure TfmBuySystem.lbledSelUPSChange(Sender: TObject);
begin
     if Trim(lbledSelUPS.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelUPS.Text),24);
end;

procedure TfmBuySystem.lbledSelSwitchChange(Sender: TObject);
begin
     if Trim(lbledSelSwitch.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelSwitch.Text),25);
end;

procedure TfmBuySystem.lbledSelFloppyChange(Sender: TObject);
begin
     if Trim(lbledSelFloppy.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelFloppy.Text),26);
end;

procedure TfmBuySystem.lbledSelZipDriveChange(Sender: TObject);
begin
     if Trim(lbledSelZipDrive.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelZipDrive.Text),27);
end;

procedure TfmBuySystem.lbledSelExtraChange(Sender: TObject);
begin
     if Trim(lbledSelExtra.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelExtra.Text),28);
end;

procedure TfmBuySystem.btnSelRamClick(Sender: TObject);
begin
     SelectedFieldExe(True,2);
end;

procedure TfmBuySystem.btnSelHardClick(Sender: TObject);
begin
     SelectedFieldExe(True,3);
end;

procedure TfmBuySystem.btnSelMBClick(Sender: TObject);
begin
     SelectedFieldExe(True,4);
end;

procedure TfmBuySystem.btnSelMonitorClick(Sender: TObject);
begin
     SelectedFieldExe(True,5);
end;

procedure TfmBuySystem.btnSelCaseClick(Sender: TObject);
begin
     SelectedFieldExe(True,6);
end;

procedure TfmBuySystem.btnSelCdRomClick(Sender: TObject);
begin
     SelectedFieldExe(True,7);
end;

procedure TfmBuySystem.btnSelCdWriterClick(Sender: TObject);
begin
     SelectedFieldExe(True,8);
end;

procedure TfmBuySystem.btnSelDvdRomClick(Sender: TObject);
begin
     SelectedFieldExe(True,9);
end;

procedure TfmBuySystem.btnSelDvdWriterClick(Sender: TObject);
begin
     SelectedFieldExe(True,10);
end;

procedure TfmBuySystem.btnSelSpeakerClick(Sender: TObject);
begin
     SelectedFieldExe(True,11);
end;

procedure TfmBuySystem.btnSelKeyBoardClick(Sender: TObject);
begin
     SelectedFieldExe(True,12);
end;

procedure TfmBuySystem.btnSelMouseClick(Sender: TObject);
begin
     SelectedFieldExe(True,13);
end;

procedure TfmBuySystem.btnSelSoundClick(Sender: TObject);
begin
     SelectedFieldExe(True,14);
end;

procedure TfmBuySystem.btnSelVGAClick(Sender: TObject);
begin
     SelectedFieldExe(True,15);
end;

procedure TfmBuySystem.btnSelScannerClick(Sender: TObject);
begin
     SelectedFieldExe(True,16);
end;

procedure TfmBuySystem.btnSelPrinterClick(Sender: TObject);
begin
     SelectedFieldExe(True,17);
end;

procedure TfmBuySystem.btnSelTvCardClick(Sender: TObject);
begin
     SelectedFieldExe(True,18);
end;

procedure TfmBuySystem.btnSellanCardClick(Sender: TObject);
begin
     SelectedFieldExe(True,19);
end;

procedure TfmBuySystem.btnSelModemClick(Sender: TObject);
begin
     SelectedFieldExe(True,20);
end;

procedure TfmBuySystem.btnSelWebCamClick(Sender: TObject);
begin
     SelectedFieldExe(True,21);
end;

procedure TfmBuySystem.btnSelHeadSetClick(Sender: TObject);
begin
     SelectedFieldExe(True,22);
end;

procedure TfmBuySystem.btnSelMicroPhoneClick(Sender: TObject);
begin
     SelectedFieldExe(True,23);
end;

procedure TfmBuySystem.btnSelUPSClick(Sender: TObject);
begin
     SelectedFieldExe(True,24);
end;

procedure TfmBuySystem.btnSelSwitchClick(Sender: TObject);
begin
     SelectedFieldExe(True,25);
end;

procedure TfmBuySystem.btnSelFloppyClick(Sender: TObject);
begin
     SelectedFieldExe(True,26);
end;

procedure TfmBuySystem.btnSelZipDriveClick(Sender: TObject);
begin
     SelectedFieldExe(True,27);
end;

procedure TfmBuySystem.btnSelExtraClick(Sender: TObject);
begin
     SelectedFieldExe(True,28);
end;

procedure TfmBuySystem.BtnSaveClick(Sender: TObject);
begin
          ...
          case cmbPardakhtKind.ItemIndex of
               0:
                 begin
                    if CheckData(True) Then
                    begin
                      InsertNValues(lbledFactorNo.Text,BuyDate.Date,lbledCount.Text,lbledSeller.Text,True,redComments.Text,
                 ...
                 1:
                   begin
                    if CheckData(True) Then
                    begin
                      InsertAValues(lbledFactorNo.Text,BuyDate.Date,lbledCount.Text,lbledSeller.Text,True,redComments.Text,
                                   {CpuInfo}                edCpuName.Text,edcpumark.Text,lbledSelCpu.Text,edCpuCount.Text,edCpuPrice.Text,
                                   {RamInfo}                edRamName.Text,edRamMark.Text,lbledSelRam.Text,edRamCount.Text,edRamPrice.Text,
                                   {Hardinfo}               edHardName.Text ,edHardMark.Text,lbledSelHard.Text,edHardCount.Text,edHardPrice.Text,
                                   {MainBoradInfo}          edMBName.Text,edMBMark.Text,lbledSelMb.Text,edMbCount.Text,edMBPrice.Text,
                 ...
                 2:
                   begin
                    if CheckData(True) Then
                    begin
                      InsertCValues(lbledFactorNo.Text,BuyDate.Date,lbledCount.Text,lbledSeller.Text,True,redComments.Text,
                                   {CpuInfo}                edCpuName.Text,edcpumark.Text,lbledSelCpu.Text,edCpuCount.Text,edCpuPrice.Text,
                                   {RamInfo}                edRamName.Text,edRamMark.Text,lbledSelRam.Text,edRamCount.Text,edRamPrice.Text,
                                   {Hardinfo}               edHardName.Text ,edHardMark.Text,lbledSelHard.Text,edHardCount.Text,edHardPrice.Text,
                                   {MainBoradInfo}          edMBName.Text,edMBMark.Text,lbledSelMb.Text,edMbCount.Text,edMBPrice.Text,
...
function TfmBuySystem.CheckData(ForInsert: Boolean): Boolean;
begin
     Result := True;
     if ForInsert Then
     begin
...
procedure TfmBuySystem.btnSelSellerClick(Sender: TObject);
begin
      SelectedField.FormCaption :='«‰ Œ«» ›—Ê‘‰œÂ';
      SelectedField.Query :='Select xPersonCode_Pk_AN,xIsSeller,(xName+'+QuotedStr(' ')+'+xFamily) As NameFamily From tblPerson Where xIsSeller=True Order By (xName+'+QuotedStr(' ')+'+xFamily)';
      SelectedField.DisplayFieldName := 'NameFamily';
...
procedure TfmBuySystem.lbledCountKeyPress(Sender: TObject; var Key: Char);
begin
 if (Key In ['a'..'z']) or (Key in ['A'..'Z'])or (Key In ['"',',',':',';','?','|','\','`','~','!','@','#','$','%','^','&','(',')','{','}','[',']']) then
    key:=#0;
end;

procedure TfmBuySystem.ClearAllTextBox;
Var
   i:Integer;
begin
...
procedure TfmBuySystem.LoadDate(OrderCode: Integer);
Var
   thisGpCode:Integer;
begin
               ...
               0:
                 begin
                      ...
                      begin
                           ...
                           NlbledAsembelPriceEdit.Text       := FieldByName('xAsemblePrice').AsString;
...
procedure TfmBuySystem.lbledSellerEditChange(Sender: TObject);
begin
     if Trim(lbledSellerEdit.Text) <> '' Then
        fmDMmain.tblPerson.Locate('xPersonCode_Pk_AN',StrToInt(lbledSellerEdit.Text),[]);
end;

procedure TfmBuySystem.lbledSellerEditKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key=VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelOrderKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key=VK_DOWN Then
     begin
          SelectedField.FormCaption      := '‘„«—Â ›«ò Ê— Œ—Ìœ';
          SelectedField.Query            := ' select xBuyOrderFactorNo,xOrderNo_Pk_AN,xIsSystemOrder From tblOrder Where xIsSystemOrder=True ';
...
procedure TfmBuySystem.AddBitBtn55Click(Sender: TObject);
begin
      SelectedField.FormCaption      := '‘„«—Â ›«ò Ê— Œ—Ìœ';
      SelectedField.Query            := ' select xBuyOrderFactorNo,xOrderNo_Pk_AN,xIsSystemOrder From tblOrder Where xIsSystemOrder=True ';
      SelectedField.DisplayFieldName := 'xBuyOrderFactorNo';
...
procedure TfmBuySystem.AddBitBtn14Click(Sender: TObject);
begin
      SelectedField.FormCaption :='«‰ Œ«» ›—Ê‘‰œÂ';
      SelectedField.Query :='Select xPersonCode_Pk_AN,xIsSeller,(xName+'+QuotedStr(' ')+'+xFamily) As NameFamily From tblPerson Where xIsSeller=True Order By (xName+'+QuotedStr(' ')+'+xFamily)';
      SelectedField.DisplayFieldName := 'NameFamily';
...
procedure TfmBuySystem.cmbpardakhtKindEditChange(Sender: TObject);
Var
   TotalPrice:String;
begin
...
procedure TfmBuySystem.lbledSelOrderChange(Sender: TObject);
begin
     if not (Trim(lbledSelOrder.Text)='') Then
        LoadDate(StrToInt(lbledSelOrder.Text));
end;

procedure TfmBuySystem.lbledSelCpuEditChange(Sender: TObject);
begin
     if Trim(lbledSelCpuEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelCpuEdit.Text),1);
end;

procedure TfmBuySystem.lbledSelCpuEditKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key=VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelCpuEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,1);
end;

procedure TfmBuySystem.lbledSelRamEditChange(Sender: TObject);
begin
     if Trim(lbledSelRamEdit.Text)= '' then Exit;
     LoadDevice(False,StrToint(lbledSelRamEdit.Text),2);
end;

procedure TfmBuySystem.btnSelRamEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,2);
end;

procedure TfmBuySystem.lbledSelRamEditKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelHardEditChange(Sender: TObject);
begin
     if Trim(lbledSelHardEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelHardEdit.Text),3);
end;

procedure TfmBuySystem.btnSelHardEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,3);
end;

procedure TfmBuySystem.lbledSelHardEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelMbEditChange(Sender: TObject);
begin
     if Trim(lbledSelMbEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelMbEdit.Text),4);
end;

procedure TfmBuySystem.lbledSelMbEditKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelMBEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,4);
end;

procedure TfmBuySystem.lbledSelMonitorEditChange(Sender: TObject);
begin
     if Trim(lbledSelMonitorEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelMonitorEdit.Text),5);
end;

procedure TfmBuySystem.lbledSelMonitorEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelMonitorEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,5);
end;

procedure TfmBuySystem.lbledSelCaseEditChange(Sender: TObject);
begin
     if Trim(lbledSelCaseEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelCaseEdit.Text),6);
end;

procedure TfmBuySystem.lbledSelCaseEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelCaseEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,6);
end;

procedure TfmBuySystem.lbledSelCdRomEditChange(Sender: TObject);
begin
     if Trim(lbledSelCdRomEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelCdRomEdit.Text),7);
end;

procedure TfmBuySystem.btnSelCdRomEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,7);
end;

procedure TfmBuySystem.lbledSelCdRomEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.lbledSelCdWriterEditChange(Sender: TObject);
begin
     if Trim(lbledSelCdWriterEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelCdWriterEdit.Text),8);
end;

procedure TfmBuySystem.lbledSelCdWriterEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelCdWriterEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,8);
end;

procedure TfmBuySystem.lbledSelDvdRomEditChange(Sender: TObject);
begin
     if Trim(lbledSelDvdRomEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelDvdRomEdit.Text),9);
end;

procedure TfmBuySystem.lbledSelDvdRomEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelDvdRomEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,9);
end;

procedure TfmBuySystem.lbledSelDvdWriterEditChange(Sender: TObject);
begin
     if Trim(lbledSelDvdWriterEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelDvdWriterEdit.Text),10);
end;

procedure TfmBuySystem.lbledSelDvdWriterEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelDvdWriterEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,10);
end;

procedure TfmBuySystem.lbledSelSpeakerEditChange(Sender: TObject);
begin
     if Trim(lbledSelSpeakerEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelSpeakerEdit.Text),11);
end;

procedure TfmBuySystem.lbledSelSpeakerEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelSpeakerEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,11);
end;

procedure TfmBuySystem.lbledSelKeyBoardEditChange(Sender: TObject);
begin
     if Trim(lbledSelKeyBoardEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelKeyBoardEdit.Text),12);
end;

procedure TfmBuySystem.lbledSelKeyBoardEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelKeyBoardEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,12);
end;

procedure TfmBuySystem.lbledSelMouseEditChange(Sender: TObject);
begin
     if Trim(lbledSelMouseEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelMouseEdit.Text),13);
end;

procedure TfmBuySystem.lbledSelMouseEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelMouseEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,13);
end;

procedure TfmBuySystem.lbledSelSoundEditChange(Sender: TObject);
begin
     if Trim(lbledSelSoundEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelSoundEdit.Text),14);
end;

procedure TfmBuySystem.lbledSelSoundEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelSoundEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,14);
end;

procedure TfmBuySystem.lbledSelVGAEditChange(Sender: TObject);
begin
     if Trim(lbledSelVGAEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelVGAEdit.Text),15);
end;

procedure TfmBuySystem.lbledSelVGAEditKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelVGAEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,15);
end;

procedure TfmBuySystem.lbledSelScannerEditChange(Sender: TObject);
begin
     if Trim(lbledSelScannerEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelScannerEdit.Text),16);
end;

procedure TfmBuySystem.lbledSelScannerEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelScannerEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,16);
end;

procedure TfmBuySystem.lbledSelPrinterEditChange(Sender: TObject);
begin
     if Trim(lbledSelPrinterEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelPrinterEdit.Text),17);
end;

procedure TfmBuySystem.btnSelPrinterEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,17);
end;

procedure TfmBuySystem.lbledSelTvCardEditChange(Sender: TObject);
begin
     if Trim(lbledSelTvCardEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelTvCardEdit.Text),18);
end;

procedure TfmBuySystem.lbledSelTvCardEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelTvCardEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,18);
end;

procedure TfmBuySystem.lbledSelLanCardEditChange(Sender: TObject);
begin
     if Trim(lbledSelLanCardEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelLanCardEdit.Text),19);
end;

procedure TfmBuySystem.lbledSelLanCardEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSellanCardEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,19);
end;

procedure TfmBuySystem.lbledSelModemEditChange(Sender: TObject);
begin
     if Trim(lbledSelModemEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelModemEdit.Text),20);
end;

procedure TfmBuySystem.lbledSelModemEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelModemEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,20);
end;

procedure TfmBuySystem.lbledSelWebCamEditChange(Sender: TObject);
begin
     if Trim(lbledSelWebCamEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelWebCamEdit.Text),21);
end;

procedure TfmBuySystem.lbledSelWebCamEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelWebCamEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,21);
end;

procedure TfmBuySystem.lbledSelHeadSetEditChange(Sender: TObject);
begin
     if Trim(lbledSelHeadSetEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelHeadSetEdit.Text),22);
end;

procedure TfmBuySystem.lbledSelHeadSetEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnselHeadSetEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,22);
end;

procedure TfmBuySystem.lbledSelMicroPhoneEditChange(Sender: TObject);
begin
     if Trim(lbledSelMicroPhoneEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelMicroPhoneEdit.Text),23);
end;

procedure TfmBuySystem.lbledSelMicroPhoneEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelMicroPhoneEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,23);
end;

procedure TfmBuySystem.lbledSelUPSEditChange(Sender: TObject);
begin
     if Trim(lbledSelUPSEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelUPSEdit.Text),24);
end;

procedure TfmBuySystem.lbledSelUPSEditKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelUPSEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,24);
end;

procedure TfmBuySystem.lbledSelSwitchEditChange(Sender: TObject);
begin
     if Trim(lbledSelSwitchEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelSwitchEdit.Text),25);
end;

procedure TfmBuySystem.lbledSelSwitchEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelSwitchEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,25);
end;

procedure TfmBuySystem.lbledSelFloppyEditChange(Sender: TObject);
begin
     if Trim(lbledSelFloppyEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelFloppyEdit.Text),26);
end;

procedure TfmBuySystem.lbledSelFloppyEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelFloppyEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,26);
end;

procedure TfmBuySystem.lbledSelZipDriveEditChange(Sender: TObject);
begin
     if Trim(lbledSelZipDriveEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelZipDriveEdit.Text),27);
end;

procedure TfmBuySystem.lbledSelZipDriveEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelZipDriveEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,27);
end;

procedure TfmBuySystem.lbledSelExtraEditChange(Sender: TObject);
begin
     if Trim(lbledSelExtraEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelExtraEdit.Text),28);
end;

procedure TfmBuySystem.lbledSelExtraEditKeyUp(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
     if Key = VK_DOWN Then
     begin
...
procedure TfmBuySystem.btnSelExtraEditClick(Sender: TObject);
begin
     SelectedFieldExe(False,28);
end;

procedure TfmBuySystem.btnSaveEditClick(Sender: TObject);
begin
     with TDefSystemBuyOrder do
     begin
          ...
          if CheckData(False)Then
             case cmbpardakhtKindEdit.ItemIndex of
                  0:
                    begin
                         if CheckData(False) Then
                             UpdateNValueS(lbledSelOrder.Text,lbledFactorNoEdit.Text,BuyDateEdit.Date,lbledCountEdit.Text,lbledSellerEdit.Text,True,redCommentsEdit.Text,
                  ...
                  1:
                    begin
                         if CheckData(False) Then
                                 UpdateAValueS(lbledSelOrder.Text,lbledFactorNoEdit.Text,BuyDateEdit.Date,lbledCountEdit.Text,lbledSellerEdit.Text,True,redCommentsEdit.Text,
                                               {Cpu Info}          edCpuNameEdit.Text,edCpuMarkEdit.Text,lbledSelCpuEdit.Text,edCpuCountEdit.Text,edCpuPriceEdit.Text,
                                               {Ram Info}          edRamNameEdit.Text,edRamMarkEdit.Text,lbledSelRamEdit.Text,edRamCountEdit.Text,edRamPriceEdit.Text,
                                               {Hard Info}         edHardNameEdit.Text,edHardMarkEdit.Text,lbledSelHardEdit.Text,edHardCountEdit.Text,edHardPriceEdit.Text,
                                               {Main Info}         edMBNameEdit.Text,edMBMarkEdit.Text,lbledSelMbEdit.Text,edMBCountEdit.Text,edMBPriceEdit.Text,
                                               ...
                                               {Extra info}        edExtraNameEdit.Text,edExtraMarkEdit.Text,lbledSelExtraEdit.Text,edExtraCountEdit.Text,edExtraPriceEdit.Text,
                                               {GP info}           cmbpardakhtKindEdit.Text,redGPCommentsEdit.Text,
                                               {Aghsat info}       AlbledTotalGpEdit.Text,AlbledPishPardakhtEdit.Text,AlbledVarantyPriceEdit.Text,AlbledAsembelPriceEdit.Text,AlbledTakhfifEdit.Text,AlbledMandeEdit.Text,AlbledGhestDayEdit.Text,AlbledGhestPriceEdit.Text,APayDateEdit.Date,AStartDateEdit.Date,AEndDateEdit.Date,AredCommentsEdit.Text);
                    end;
                  2:
                    begin
                         if CheckData(False) Then
                                 UpdateCValueS(lbledSelOrder.Text,lbledFactorNoEdit.Text,BuyDateEdit.Date,lbledCountEdit.Text,lbledSellerEdit.Text,True,redCommentsEdit.Text,
                                               {Cpu Info}          edCpuNameEdit.Text,edCpuMarkEdit.Text,lbledSelCpuEdit.Text,edCpuCountEdit.Text,edCpuPriceEdit.Text,
                                               {Ram Info}          edRamNameEdit.Text,edRamMarkEdit.Text,lbledSelRamEdit.Text,edRamCountEdit.Text,edRamPriceEdit.Text,
                                               {Hard Info}         edHardNameEdit.Text,edHardMarkEdit.Text,lbledSelHardEdit.Text,edHardCountEdit.Text,edHardPriceEdit.Text,
                                               {Main Info}         edMBNameEdit.Text,edMBMarkEdit.Text,lbledSelMbEdit.Text,edMBCountEdit.Text,edMBPriceEdit.Text,
...
procedure TfmBuySystem.btnDelClick(Sender: TObject);
begin
     if fmDMmain.YesNoDialog.Show('¬Ì« «ÿ„Ì‰«‰ œ«—Ìœ ø',HbtWarning) Then
        fmDMmain.tblOrder.Delete;
end;

function TfmBuySystem.Calc(ForInsert:Boolean): String;
var
   thisResult : Double;
begin
     thisResult := 0.0;
...
procedure TfmBuySystem.btnCalcEditClick(Sender: TObject);
Var
   TotalPrice:String;
begin
     TotalPrice := Calc(False);
...
procedure TfmBuySystem.btnCalc1Click(Sender: TObject);
Var
   TotalPrice:String;
begin
     TotalPrice := Calc(True);
...
function TfmBuySystem.CalcMande(ForInsert: Boolean): String;
var
   thisResult : Integer;
begin
     thisResult := 0;
...
procedure TfmBuySystem.NlbledTakhfifEditExit(Sender: TObject);
begin
...
procedure TfmBuySystem.AlbledTakhfifEditExit(Sender: TObject);
begin
...
procedure TfmBuySystem.ClbledTakhfifEditExit(Sender: TObject);
begin
...
procedure TfmBuySystem.NlbledTakhfifExit(Sender: TObject);
begin
...
procedure TfmBuySystem.AlbledTakhfifExit(Sender: TObject);
begin
...
procedure TfmBuySystem.ClbledTakhfifExit(Sender: TObject);
begin
...
procedure TfmBuySystem.BtnSaveNewClick(Sender: TObject);
begin
     with TDefSystemBuyOrder Do
     begin
          //if CheckData(True) Then
...
procedure TfmBuySystem.tbsEditEnter(Sender: TObject);
begin
     lbledSelOrder.SetFocus;
end;

procedure TfmBuySystem.clearAllDate;
Var
   i:Integer;
begin
     for i:=0 to componentcount-1 Do
...
procedure TfmBuySystem.btnDefSellerClick(Sender: TObject);
begin
     lbledSeller.Text := fmDefSeller.MyShowModal;
end;

procedure TfmBuySystem.AddBitBtn28Click(Sender: TObject);
begin
