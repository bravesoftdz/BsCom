...
type
  TfmStoreInfo = class(TForm)
    ...
    lbledGoodsCodeEdit: TAddLabeledEdit;
    ...
    lbledBasePrice: TAddLabeledEdit;
    lbledBasePriceEdit: TAddLabeledEdit;
...
procedure TfmStoreInfo.btnselGoodsClick(Sender: TObject);
begin
      SelectedField.TableName:= 'tblGoods';
      SelectedField.DisplayFieldName :='xGoodsName';
      SelectedField.ReturnFieldName  :='xGoodsCode_Pk_Inc';
