...
uses
    DMMain,
    MyLibrary, VarUtils, DefSeller, BuyGoods, DefCustomer;

{$R *.dfm}

procedure TfmSellGoods.FormShow(Sender: TObject);
begin
     ...
     begin
          ...
          tblOrder.Filter   := 'xBuyOrderFactorNo = Null and xIsSystemOrder = False';
...
procedure TfmSellGoods.lbledSelGoodsKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key= VK_DOWN Then
...
procedure TfmSellGoods.LoadDevice(ForInsert: Boolean;deviceCode:Integer);
begin
...
procedure TfmSellGoods.SelectedFieldExe(ForInsert: Boolean);
begin
...
procedure TfmSellGoods.btnSelGoodsClick(Sender: TObject);
begin
     SelectedFieldExe(True);     
end;

procedure TfmSellGoods.btnSelGoodsEditClick(Sender: TObject);
begin
     SelectedFieldExe(False);
end;

procedure TfmSellGoods.lbledSelGoodsEditKeyUp(Sender: TObject;
...
procedure TfmSellGoods.lbledSelGoodsChange(Sender: TObject);
begin
     if Trim(lbledSelGoods.Text) = '' Then Exit;
     LoadDevice(True,StrToint(lbledSelGoods.Text));
end;

procedure TfmSellGoods.FormKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfmSellGoods.lbledSelGoodsEditChange(Sender: TObject);
begin
     if Trim(lbledSelGoodsEdit.Text) = '' Then Exit;
     LoadDevice(False,StrToint(lbledSelGoodsEdit.Text));
end;

procedure TfmSellGoods.FormClose(Sender: TObject; var Action: TCloseAction);
begin
     with fmDMmain do
     begin
          tblPerson.Filtered := False;
...
procedure TfmSellGoods.btnSelSellerEditClick(Sender: TObject);
begin
...
procedure TfmSellGoods.lbledSellerEditKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key=VK_DOWN Then
     begin
...
procedure TfmSellGoods.lbledSellerEditChange(Sender: TObject);
begin
     if Trim(lbledSellerEdit.Text) <> '' Then
        fmDMmain.tblPerson.Locate('xPersonCode_Pk_AN',StrToInt(lbledSellerEdit.Text),[]);
end;

procedure TfmSellGoods.btnAddToListEditClick(Sender: TObject);
begin
...
function TfmSellGoods.Calc(ForInsert: Boolean;ordercode:Integer): String;
Var
   thisQry : TMADOQuery ;
begin
...
function TfmSellGoods.CalcMande(ForInsert: Boolean): String;
var
   thisResult : Integer;
begin
     thisResult := 0;
...
function TfmSellGoods.CheckData(ForInsert: Boolean): Boolean;
begin
     Result := True;
     if ForInsert Then
     begin
...
procedure TfmSellGoods.ClearAllTextBox;
Var
   i:Integer;
begin
...
procedure TfmSellGoods.LoadDate(OrderCode: Integer);
Var
   thisGpCode:Integer;
begin
...
procedure TfmSellGoods.lbledSellerChange(Sender: TObject);
begin
     if Trim(lbledSeller.Text) <> '' Then
        fmDMmain.tblPerson.Locate('xPersonCode_Pk_AN',StrToInt(lbledSeller.Text),[]);
end;

procedure TfmSellGoods.lbledSellerKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key=VK_DOWN Then
     begin
...
procedure TfmSellGoods.btnSelSellerClick(Sender: TObject);
begin
      SelectedField.FormCaption :='«‰ Œ«» Œ—Ìœ«—';
      SelectedField.Query :='Select xPersonCode_Pk_AN,xIsSeller,(xName+'+QuotedStr(' ')+'+xFamily) As NameFamily From tblPerson Where xIsSeller = False Order By (xName+'+QuotedStr(' ')+'+xFamily)';
      SelectedField.DisplayFieldName := 'NameFamily';
...
procedure TfmSellGoods.btnAddToListClick(Sender: TObject);
begin
     with TDefSellGoodsOrderClass do
     begin
          if CheckGoodsData(True) Then
          begin
               if thisOrderCode = 0 Then
               begin
                  thisOrderCode := InsertOrderValue(StrToInt(lbledFactorNo.Text),SellDate.Date,StrToInt(lbledGoodsCount.Text),StrToInt(lbledSeller.Text),redOrderComments.Text);
...
procedure TfmSellGoods.lbledFactorNoChange(Sender: TObject);
begin
     if fmDMmain.tblOrder.Active Then
     begin
         fmDMmain.tblOrder.Locate('xOrderNo_Pk_AN',thisOrderCode,[]);
         if Not( fmDMmain.tblOrder.FieldByName('xSellFactorNo').AsString = lbledFactorNo.Text ) Then
            thisOrderCode:= 0;
     end;
end;

procedure TfmSellGoods.btnDelFromListClick(Sender: TObject);
begin
     if fmDMmain.YesNoDialog.Show('¬Ì« «ÿ„Ì‰«‰ œ«—Ìœ ø',HbtInformation) Then
        fmDMmain.tblOrderGoodsList.Delete;
end;

procedure TfmSellGoods.btnCalcClick(Sender: TObject);
Var
   TotalPrice:String;
begin
...
procedure TfmSellGoods.BtnSaveClick(Sender: TObject);
begin
     case cmbpardakhtKind.ItemIndex of
...
procedure TfmSellGoods.BtnSaveNewClick(Sender: TObject);
begin
     case cmbpardakhtKind.ItemIndex of
        0:NlbledMande.Text:= CalcMande(True);
        1:AlbledMande.Text:= CalcMande(True);
...
procedure TfmSellGoods.btnDelClick(Sender: TObject);
begin
     if fmDMmain.YesNoDialog.Show('¬Ì« «ÿ„Ì‰«‰ œ«—Ìœ ø',HbtInformation) Then
        fmDMmain.tblOrder.Delete;
end;

procedure TfmSellGoods.lbledSelorderKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
     if Key= Vk_down Then
     begin
          SelectedField.FormCaption      := '‘„«—Â ›«ò Ê— ›—Ê‘';
          SelectedField.Query            := ' select xSellFactorNo,xOrderNo_Pk_AN,xIsSystemOrder,xBuyOrderFactorNo From tblOrder Where xSellFactorNo <> Null and xIsSystemOrder = False ';
...
procedure TfmSellGoods.btnselOrderClick(Sender: TObject);
begin
      SelectedField.FormCaption      := '‘„«—Â ›«ò Ê— ›—Ê‘';
      SelectedField.Query            := ' select xSellFactorNo,xOrderNo_Pk_AN,xIsSystemOrder,xBuyOrderFactorNo From tblOrder Where xSellFactorNo <> Null and xIsSystemOrder = False ';
      SelectedField.DisplayFieldName := 'xSellFactorNo';
...
procedure TfmSellGoods.lbledSelorderChange(Sender: TObject);
begin
     if Trim(lbledSelorder.Text)='' Then Exit;
     LoadDate(StrToInt(lbledSelorder.Text));
end;

procedure TfmSellGoods.ClearGoodsInfo(ForInsert:Boolean);
begin
     if ForInsert Then
     begin
          lbledSelGoods.Clear;
...
procedure TfmSellGoods.btnDelFromListEditClick(Sender: TObject);
begin
     if fmDMmain.YesNoDialog.Show('¬Ì« «ÿ„Ì‰«‰ œ«—Ìœ ø',HbtInformation) Then
        fmDMmain.tblOrderGoodsList.Delete;
end;

procedure TfmSellGoods.btnCalcEditClick(Sender: TObject);
Var
   TotalPrice:String;
begin
     if Trim(lbledSelorder.Text)='' Then Exit;
...
procedure TfmSellGoods.NlbledTakhfifEditExit(Sender: TObject);
begin
     if NlbledTakhfifEdit.Text = '' Then
        NlbledTakhfifEdit.Text := '0';
end;

procedure TfmSellGoods.AlbledTakhfifEditExit(Sender: TObject);
begin
     if AlbledTakhfifEdit.Text = '' Then
        AlbledTakhfifEdit.Text := '0';
end;

procedure TfmSellGoods.ClbledTakhfifEditExit(Sender: TObject);
begin
     if ClbledTakhfifEdit.Text = '' Then
        ClbledTakhfifEdit.Text := '0';
end;

procedure TfmSellGoods.cmbpardakhtKindEditChange(Sender: TObject);
Var
   TotalPrice:String;
begin
...
procedure TfmSellGoods.cmbPardakhtKindChange(Sender: TObject);
var
   totalPrice:String;
begin
     if thisOrderCode <> 0 then
...
procedure TfmSellGoods.BtnCloseClick(Sender: TObject);
begin
     Close;
end;

procedure TfmSellGoods.lbledGoodsCountKeyPress(Sender: TObject;
  var Key: Char);
begin
...
procedure TfmSellGoods.tbsEditEnter(Sender: TObject);
begin
     lbledSelorder.SetFocus;
end;

procedure TfmSellGoods.redOrderCommentsEditEnter(Sender: TObject);
begin
     redCommentsEdit.SelStart :=0;
end;

procedure TfmSellGoods.redVarantyCommentEditEnter(Sender: TObject);
begin
     redVarantyCommentEdit.SelStart := 0;
end;

procedure TfmSellGoods.btnSaveEditClick(Sender: TObject);
begin
     case cmbpardakhtKindEdit.ItemIndex of
     ...
     begin
          ...
          begin
               updateOrderValue(lbledSelorder.Text,lbledFactorNoEdit.Text,SellDateEdit.Date,lbledSellerEdit.Text,redOrderCommentsEdit.Text);
               case cmbpardakhtKindEdit.ItemIndex of
...
function TfmSellGoods.CheckGoodsData(ForInsert: Boolean): Boolean;
begin
     Result := True;
     if ForInsert Then
     begin
...
procedure TfmSellGoods.ClbledTakhfifExit(Sender: TObject);
begin
     if ClbledTakhfif.Text = '' Then
        ClbledTakhfif.Text := '0';
end;

procedure TfmSellGoods.AlbledTakhfifExit(Sender: TObject);
begin
     if AlbledTakhfif.Text = '' Then
        AlbledTakhfif.Text := '0';
end;

procedure TfmSellGoods.NlbledTakhfifExit(Sender: TObject);
begin
     if NlbledTakhfif.Text = '' Then
        NlbledTakhfif.Text := '0';
end;

procedure TfmSellGoods.clearAllDate;
Var
   i:Integer;
begin
     for i:=0 to componentcount-1 Do
...
procedure TfmSellGoods.btnDefSellerEditClick(Sender: TObject);
begin
     lbledSellerEdit.Text := fmDefSeller.MyShowModal();
end;

procedure TfmSellGoods.btnDefSellerClick(Sender: TObject);
begin
     ShowMessage(' ');
     lbledSeller.Text := fmDefCustomer.MyShowModal();
end;
